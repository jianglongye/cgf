...
def build_ball_joint(
    robot_builder: sapien.ArticulationBuilder, parent: sapien.LinkBuilder, name: str, pose: Pose
    ...
    for i in range(3):
        ...
        link.set_joint_properties(
            "revolute", limits=joint_limit, pose_in_parent=pose_in_parent[i], pose_in_child=pose_in_child[i]
        )
    return links
