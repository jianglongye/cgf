...
class TableDoorRLEnv(TableDoorEnv, BaseRLEnv):
    ...
    def get_oracle_state(self):
        ...
        return np.concatenate(
            [robot_qpos_vec, door_qpos_vec, palm_v, palm_w, handle_in_palm, [int(self.is_contact), int(self.is_unlock)]]
        )
...
def main_env():
    ...
    base_env = TableDoorRLEnv(use_gui=True, robot_name="allegro_hand_xarm6_wrist_mounted_rotate3")
