...
class DrawerFetchObjectEnv(BaseSimulationEnv):
    ...
    def load_drawer(self):
        urdf = download_maniskill(self.partnet_mobility_id, directory=None)
    ...
    def create_table(self, table_height=1.0, table_half_size=(0.8, 0.8, 0.025)):
        ...
        if self.renderer:
            ...
            table_visual_material.set_diffuse_texture_from_file(
                "/home/sim/project/dex_ycb_imitation/hand_teleop/assets/misc/table_map.jpg"
            )
            table_visual_material.set_roughness(0.3)
            builder.add_visual_from_file(
                "/home/sim/project/dex_ycb_imitation/hand_teleop/assets/misc/cube.obj",
                pose=top_pose,
            ...
            builder.add_box_visual(
                pose=sapien.Pose([x, y, leg_height]), half_size=leg_size, material=table_visual_material
            )
            builder.add_box_visual(
                pose=sapien.Pose([x, -y, leg_height]), half_size=leg_size, material=table_visual_material
            )
