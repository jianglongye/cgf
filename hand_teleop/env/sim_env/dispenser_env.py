...
class DispenserEnv(BaseSimulationEnv):
    ...
    def load_functional_region(self):
        viz_mat = create_visual_material(self.renderer, 0.1, 0.5, 0.4, base_color=np.array([1, 0, 0, 0.6]))
...
class MPC:
    def __init__(
        self, env: KinematicsDispenserEnv, plan_horizon=8, popsize=200, num_elites=20, max_iters=4, use_mpc=True
    ):
        self.env = env
